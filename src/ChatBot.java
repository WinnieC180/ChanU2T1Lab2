public class ChatBot {
    ...
    // constructor
    public ChatBot(String chatBotName, int faveNum, String faveColor) {
        name = chatBotName;
        number = faveNum;
        color = faveColor;
    }
    ...
    //method printing favorite color
    public void favColor(String favColor) {
        System.out.println(favColor + " is a pretty color too!");
        System.out.println("My favorite color is " + color);
    }

    public String date() {
        return "September 28, 22";
    }
